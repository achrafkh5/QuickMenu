    ...
    <div className={styles.body}>
      ...
      <nav className={styles.navbar}>
        <div className={styles.navLogo}>
          <span className={styles.logoIcon}><i className="fas fa-qrcode" style={{color:"white"}}></i></span>
          <span className={styles.logoText}>QuickMenu</span>
        </div>
        <div className={styles.navLinks}>
          <Link href="/login" prefetch={true} className={styles.navLink}>Login</Link>
          <Link href="/signup" prefetch={true} className={styles.navLink}>Sign Up</Link>
        </div>
      </nav>
