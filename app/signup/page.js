...
function Signup() {
  ...
  const handleSignUp = async () => {
    ...
    if (!uploadResponse.ok) {
      ...
      const avatar = {
        public_id: uploadData.avatar.public_id,
    ...
    <div className={styles.body}>
      ...
      <div className={styles.login}>
        ...
        <div className={styles.user_photo}>
          ...
          <input className={styles.catphoto} id="catphoto" type="file" accept="image/*" onChange={(e) => setFile(e.target.files[0] || null)} disabled={loading} />
